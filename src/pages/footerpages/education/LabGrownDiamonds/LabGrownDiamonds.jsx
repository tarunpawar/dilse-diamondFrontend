    ...
    <>
          ...
          <div className="row pb-4">
            ...
            <div className="col-md-6">
              <div className="here-rightside">
                ...
                <span className="heaing-para">All about lab grown diamonds and rings.</span>
      ...
      <section>
        <div className="container">
          ...
          <p className="text-center pt-3">How are lab diamonds made, how long is the process to create a lab diamond, how are lab-created diamonds grown?</p>
            ...
            <div className="row g-4">
              ...
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  <h5>GIA</h5>
                  <p>
                    <strong>Gemological Institute of America</strong><br />
                    The Gemological Institute of America is a nonprofit institute that has
                    an international authority on diamonds, gemstones, and pearls. GIA was
              ...
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  <h5>AWDC</h5>
                  <p>
                    <strong>Antwerp World Diamond Center</strong><br />
                    Antwerp World Diamond Center is recognized as one of the leaders in
                    the diamond industry. For more than five centuries, Antwerp in the
                    country of Belgium has been the capital for international diamond
                    trade. They stand for transparency, integrity, quality, and
                    sustainability. Their mission is to inspire current and future
                    generations to keep Antwerp at the forefront of the diamond trade
                    industry.
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  <h5>AGS</h5>
                  <p>
                    <strong>American Gem Society</strong><br />
                    The American Gem Society started in 1943 to protect jewelry consumers.
                    While the Gemological Institute of America (GIA) is the industry’s
                    leading diamond lab, the AGS is not far behind. Like GIA, AGS is also
                    a nonprofit organization. AGS stands out amongst other diamond grading
                    systems because they use a 0 to 10 scale, with 0 as the best and 10 as
                    the worst.
                  </p>
                </div>
              </div>
            ...
            <div className="row g-4 mt-3">
              ...
              <div className="col-md-6">
                <div className="text-center">
                  ...
                  <h5>IGI</h5>
                  <p>
                    <strong>International Gemological Institute</strong><br />
                    The International Gemological Institute is the world’s largest
                    independent gemstone grading organization. Established in 1975, IGI
                    now has offices all over the globe, with 18 lab locations. This
                    laboratory carefully studies colored stones and jewelry, along with
                    lab grown diamonds, to determine authenticity. They also have 14
                    schools of gemology.
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-6">
                <div className="text-center">
                  ...
                  <h5>GSI</h5>
                  <p>
                    <strong>Gemological Science International</strong><br />
                    At Gemological Science International, hundreds of researchers use
                    advanced technology and intelligent software to automate the diamond
                    grading process. GSI diamond grading reports stand for “innovation,
                    integrity, and professionalism.” Their labs in the United States,
                    India, Belgium, and Israel follow the alphabetical grading system.
                  </p>
                </div>
              </div>
            </div>
