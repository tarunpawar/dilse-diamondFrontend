        ...
        <>
            <section>
                ...
                <div className='text-center'>
                    <span style={{ fontSize: '20px', lineHeight: '1.4', textAlign: 'center' }}>Do you have a Dilse Jewels Credit Card? <a style={{ textDecoration: 'none' }} href="">Manage your account</a> </span>
                </div>
