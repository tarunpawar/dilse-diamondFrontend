...
const Signature = () => {
  const details = [
    ...
    },
    {
      ...
      image:
        "https://www.withclarity.com/cdn/shop/files/w_r2_480x.jpg?v=1746013584",
    },
    {
      ...
      image:
        "https://www.withclarity.com/cdn/shop/files/w_r3_480x.jpg?v=1746013690",
    },
  ];
    ...
    <>
      ...
      <section className="hero_section_wrapper">
        <div className="container-fluid p-0 position-relative">
          <video width="100%" height="100%" autoPlay muted loop>
            <source
              src="https://cdn.shopify.com/videos/c/o/v/7016be705fe24c0387a61899487b6000.mp4"
              type="video/mp4"
            />
          </video>
        </div>
      ...
      <section className="w-signature-description py-5">
        <p className="description-text container">
          <strong>The W Signature</strong> showcases a distinctive W-shaped
          basket, inspired by the Dilsejewels brand name. Designed to
          celebrate the brilliance <br /> of the center stone, The W Signature
          embodies timeless artistry, creating an iconic silhouette that remains
